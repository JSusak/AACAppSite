...
export const timelineCardContents = [
  //workshop 1,
  {
    ...
    modalDescription:
      "Co-design workshop one explored participants’ communication experiences in different public contexts. We wanted our co-designers to feel empowered to share their unique stories about varying experiences with communication partners across multiple contexts. This consisted of using laminated tangible context cards (e.g., cinema, supermarket etc.). With cards, participants spontaneously shared stories when prompted by each card context. Followed by a group activity ranking each conversation context. We supported participants ranking frequency of visiting a context (Never to Daily) and they rated the degree of difficulty presented by communication within this setting (Easy to Hard).",
  ...
  //workshop 2,
  {
    ...
    modalDescription:
      "The second co-design workshop focused on supporting our co-designers to define and ideate low-fidelity solutions using craft materials. We prompted participants to envisage a ‘super’ tool that could assist them with these communication problems and enhance their pre-existing communication abilities. Amongst the small groups, the SLT/ researcher would mediate discussions and appropriately use closed ‘yes/no’ questioning to support prototyping activities (e.g., drawing, writing and cutting) of a high-volume of participants’ solutions. Low-fidelity wireframes were also successfully used by our codesigners to tangibly supplement their dialogue and expression.",
